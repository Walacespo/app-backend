package com.walace.cursomc.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.walace.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API  Spring Boot",
				"Esta API é utilizada na aplicativo de pedido", 
				"Versão 1.0",
				"https://www.teste.com/terms",
				new Contact("Walace da Silva", "teste.com/user/walace-silva", "walacespo@gmail.com"),
