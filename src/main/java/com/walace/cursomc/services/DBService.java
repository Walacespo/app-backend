...
import com.walace.cursomc.domain.ItemPedido;
import com.walace.cursomc.domain.Pagamento;
import com.walace.cursomc.domain.PagamentoComBoleto;
import com.walace.cursomc.domain.PagamentoComCartao;
import com.walace.cursomc.domain.Pedido;
import com.walace.cursomc.domain.Produto;
import com.walace.cursomc.domain.enums.EstadoPagamento;
import com.walace.cursomc.domain.enums.Perfil;
...
import com.walace.cursomc.repositories.ItemPedidoRepository;
import com.walace.cursomc.repositories.PagamentoRepository;
import com.walace.cursomc.repositories.PedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria da Silva", "walace.front@gmail.com","5533558778",TipoCliente.PESSOAFISICA, pe.encode("123") );
		cli1.getTelefones().addAll(Arrays.asList("245588779","2455887963"));
		
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "walace@gmail.com","11401670733",TipoCliente.PESSOAFISICA, pe.encode("123") );
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("245555779","2455887955"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floes", "2214", "Sala 800","Centro","385574663", cli2, c2);
